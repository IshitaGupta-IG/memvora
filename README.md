...
`GEMINI_MODELS` and `OPENROUTER_MODELS` are comma-separated fallback lists. Memvora tries up to three Gemini models first, then up to three OpenRouter free models, following `AI_PROVIDER_ORDER`.
